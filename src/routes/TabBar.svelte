...
>
  <div
    class="h-[50px] standalone:pb-[34px] standalone:h-[84px] w-full text-zinc-500 flex [&>.active]:text-blue-500 *:w-full font-medium *:text-xs *:flex *:flex-col *:items-center *:justify-center items-center justify-between justify"
  >
